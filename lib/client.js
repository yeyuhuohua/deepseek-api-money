window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    // deepseek-v4-flash-vision-exp: 视觉模型，价目同 v4-flash；图片按尺寸换算为
    // 输入 token（每张上限 384 token，见 https://api-docs.deepseek.com/guides/vision）
    var PRICES = {
      "deepseek-v4-flash": { miss: 0.22, hit: 0.007, out: 0.66 },
      "deepseek-v4-flash-vision-exp": { miss: 0.22, hit: 0.007, out: 0.66 },
