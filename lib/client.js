window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    // ---- 可调参数 ----
    var MODEL = "deepseek-v4-pro"; // 计价模型: "deepseek-v4-pro" | "deepseek-v4-flash"
    ...
    function costOf(usage, date) {
      ...
      return { usd: usd, cny: usd * CNY_PER_USD, factor: factor, input: input, output: output, cacheRead: cacheRead };
    }
    ...
    function Readout(props) {
      ...
      if (cost !== null) {
        ...
        tip.push("估算花费: $" + cost.usd.toFixed(4) + " ≈ ¥" + fmtCNY(cost.cny) + "（" + MODEL + " · " + (cost.factor === 2 ? "峰时 ×2" : "谷时") + "）");
      }
